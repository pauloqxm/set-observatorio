...
const HIDDEN_MENU_ITEMS = new Set(["texto_apoio", "config", "perfil_social", "dados_caged", "perfil_municipal", "perfil_empresas", "ceara_credi", "vai_vem", "caged_grupamentos", "series_historicas"]);
